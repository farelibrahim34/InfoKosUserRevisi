...
import com.projectfarrel.infokosuser.view.DetailPiActivity


class AdapterDataKosPi(private var listData:List<ResponseDataKosItem>): RecyclerView.Adapter<AdapterDataKosPi.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.cardList.setOnClickListener {
            val detail = Intent(it.context, DetailPiActivity::class.java)
            ...
            detail.putExtra("update",listData[position].createdAt)
